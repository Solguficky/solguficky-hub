...
# Пороги числа тестов Notifications по уровням, в сумме 261. Поднимаются вручную
...
# ловит --fail-skips.
NOTIFICATIONS_UNIT_TEST_THRESHOLD := "183"
NOTIFICATIONS_INTEGRATION_TEST_THRESHOLD := "78"
