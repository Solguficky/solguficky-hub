...
Сервис заморожен и не входит в MVP. Не реализуйте перечисленные в старых документах следующие фазы без отдельного решения владельца. Перед удалением кода нужно пройти [gate вывода Legacy](../../docs/services/auction.md#gate-вывода-legacy).
