...
|---|---|---|
| Unit | чистая доменная логика, FSM, UI builders, mapping, error branches | Identity: Go tests; Telegram Bot: Vitest; C# xUnit 2; F# xUnit v3 + Unquote, FsCheck для properties |
