...
| Identity | Граница, модель доступа и стек Accepted: ADR-026, ADR-027; временный bootstrap первого администратора Accepted: [ADR-035](../decisions/ADR-035-temporary-first-admin-bootstrap.md); контракт разрешения личности Accepted, остальные Open | Telegram identity, допуск к продукту и общие роли |
