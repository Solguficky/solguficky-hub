...
| Identity | Скелет gRPC-сервера: заглушка `ResolveIdentity`, health, структурные логи и миграции PostgreSQL профиля и глобальных ролей; логики разрешения нет | Telegram identity, допуск к продукту и системные роли |
