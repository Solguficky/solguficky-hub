...
| Identity | Граница, модель доступа и стек Accepted: ADR-026, ADR-027; первая выдача роли администратора в срезе — временный bootstrap Accepted: [ADR-036](../decisions/ADR-036-temporary-first-admin-bootstrap.md); контракт разрешения личности Accepted, остальные Open | Telegram identity, допуск к продукту и общие роли |
