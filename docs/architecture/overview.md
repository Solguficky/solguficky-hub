...
| Meetups | Скелет gRPC-сервиса на F#: контракт среза, C#-кодогенерация, заглушечные ответы, health, каркас лога границы и миграции состояния, журнала событий и отдельного outbox; домена нет | Владелец данных о сходках |
