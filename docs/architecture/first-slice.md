...
Meetups не существует ни как исполняемый сервис, ни как контракт. Identity отвечает на `ResolveIdentity` заглушкой без схемы и логики допуска. Срез нужен, чтобы проверить границы на работающем коде, и чтобы первая же ошибка в разделении ответственности обнаружилась на маленьком объёме.
