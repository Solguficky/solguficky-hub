...
|---|---|---|
| Администратор | глобальная роль администратора, он же автор создаваемой сходки | внутренний профиль существует, роль выдана maintainer'ом через служебный endpoint как данные ([ADR-036](../decisions/ADR-036-first-admin-via-service-endpoint.md)) |
