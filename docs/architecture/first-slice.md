...
|---|---|---|
| Администратор | глобальная роль администратора, он же автор создаваемой сходки | внутренний профиль существует, роль выдана временным bootstrap из [ADR-036](../decisions/ADR-036-temporary-first-admin-bootstrap.md) как данные в `identity_roles` |
