...
Раздел хранит устойчивые рабочие процессы и проверяемые руководства. Приоритеты, задачи и прогресс ведутся в Linear.

- [design-process.md](design-process.md) — human-owned проектирование и роль агента;
...
- [mcp-servers.md](mcp-servers.md) — исследование MCP для контура агента: сценарии, матрица и итоги.
