...
> **Статус: устаревший архитектурный срез.** Диаграмма ниже описывает существующую аукционную ветку и прежние назначения стеков. Актуальное разделение Current / MVP / Future / Legacy и зрелость решений см. в `PROJECT_CONTEXT.md`. Не использовать этот файл для выбора языка нового сервиса до синхронизации и соответствующего ADR.
