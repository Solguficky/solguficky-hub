...
> **Историческое.** Технический дизайн C#/Akka.NET-сервиса, удалённого из репозитория. Фиксирует замысел; что было реализовано на самом деле — в [разборе кода](auction-domain-and-lessons.md).
