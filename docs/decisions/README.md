...
| [ADR-016](ADR-016-rbac-action-pattern-and-transport.md) | RBAC, Action pattern и transport | Historical | Свидетельство. Hardcoded-роли заменены [ADR-026](ADR-026-identity-mvp-model-and-access.md), роли и области доступа аукциона проектирует [PER-146](https://linear.app/anticnvm/issue/per-146). Живым остался критерий выбора transport — он применяется как отправная точка в [integration.md](../architecture/integration.md); остальное относится к удалённому аукционному шлюзу |
