...
| [ADR-010](ADR-010-hybrid-auction-clients.md) | Клиенты гибридного аукциона | Superseded | Экран зала заменён [ADR-040](ADR-040-auction-screen-sse.md); два Telegram-входа, общий слой экранов и граница Mini App приняты в [ADR-044](ADR-044-two-telegram-bots-and-shared-auction-screens.md) |
