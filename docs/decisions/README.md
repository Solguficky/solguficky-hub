...
| [ADR-023](ADR-023-meetup-public-number.md) | Публичный номер сходки рядом с UUIDv7 | Active | Номер — человеческая метка, внешний routing остаётся на UUID. Сигнал пересмотра от ADR-026 разобран и закрыт: решение подтверждено 2026-08-25 с уточнённым обоснованием, раздел «Пересмотр» в самом ADR |
