...
| [ADR-033](ADR-033-meetups-functional-vertical-slices.md) | Функциональные вертикальные срезы в Meetups | Active | VSA выбран для Meetups, но не назначается всем F#-сервисам; Oxpecker ограничен HTTP-границей |
