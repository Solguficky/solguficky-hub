...
| Эфемерный ответ (`ephemeral_message_parameters`) | слой A: `message_id = 0`; offline не гарантирован | не применяется | слой C API: `200`, `message_id = 0`, есть `ephemeral_message_id` | слой C: не прогнано | слой C: ждёт, видит ли только адресат |
...
- Видит ли эфемерный ответ только адресат, или его видно всей группе.
