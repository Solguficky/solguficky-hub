...
| [RFC-013](RFC-013-phased-execution-loop-and-gates.md) | Фазовый контур исполнения и гейты решений | Draft; открыты десять вопросов, оркестратор фаз не выбран, живой прогон не сделан |
