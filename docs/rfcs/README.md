...
| [RFC-003](RFC-003-bot-presentation-rich-blocks.md) | Представление бота: плоский текст или блоки Rich Messages | Draft, документарный слой 2026-09-06; живой прогон клиентов не выполнен |
