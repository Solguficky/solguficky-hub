...
| [RFC-007](RFC-007-auction-scope-and-format-options.md) | Аукцион: формат события, объём первого запуска и реестр обещаний | Draft, ожидает ответа админа; читаемая версия — [RFC-007-auction-for-admins.html](RFC-007-auction-for-admins.html) |
