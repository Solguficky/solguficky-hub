...
| [RFC-007](RFC-007-auction-scope-and-format-options.md) | Аукцион: формат события, объём первого запуска и реестр обещаний | Accepted, ADR не нужен; открыты дефицит встречного среза и перенос лота через дедлайн. Связанный материал — страница обсуждения [«Аукцион 2026»](../published/auction-2026/index.html) по адресу `/auction-2026` |
