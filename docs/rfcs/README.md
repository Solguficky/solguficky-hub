...
| [RFC-007](RFC-007-typescript-protobuf-codegen.md) | Кодогенерация Protobuf для TypeScript: `protoc-gen-es` и Connect gRPC | Accepted, [protobuf.md](../standards/contracts/protobuf.md#кодогенерация-typescript) |

Документы разделены по границе, которую каждый блокирует: RFC-001 — контракт расширения, RFC-002 — продуктовую модель сходки, RFC-003 — форму сообщений бота и ревизию макета, RFC-004 — схему и язык Meetups, RFC-005 — устройство Notifications и границу доставки, RFC-006 — устройство Telegram-края и его состояние, RFC-007 — кодогенерацию Protobuf для TypeScript.
