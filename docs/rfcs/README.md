...
| [RFC-012](RFC-012-testing-strategy-and-agent-qa.md) | Стратегия тестирования: пять уровней, граница гейта и агентский QA | Draft; пять открытых вопросов, включая размещение сквозных тестов |
