...
| [RFC-013](RFC-013-phased-execution-loop-and-gates.md) | Фазовый контур исполнения и гейты решений | Draft; десять вопросов закрыты владельцем 2026-09-21, форму запуска фаз выбирает сравнение Orca и CAO в прогоне PER-282 |
