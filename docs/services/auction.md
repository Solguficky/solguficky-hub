...
Доменная модель торгов — словарь, команды, события, правила и инварианты — предложена в [RFC-011](../rfcs/RFC-011-auction-trading-domain-model.md). RFC принят 21.09.2026, словарь и форма события зафиксированы [ADR](../decisions/ADR-047-auction-trading-domain-vocabulary-and-event-form.md). Формат события вынесен в конфигурацию сессии, и выбор Ф-4 модель не переписал — правила, события и инварианты остались прежними. Одного понятия конфигурации не хватило: лот, отобранный в финал, обязан пережить общий дедлайн, и способ это выразить выбирает [PER-291](https://linear.app/anticnvm/issue/per-291) до описания контрактов.
