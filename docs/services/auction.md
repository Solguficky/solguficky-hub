...
Доменная модель торгов — словарь, команды, события, правила и инварианты — предложена в [RFC-011](../rfcs/RFC-011-auction-trading-domain-model.md). Формат события вынесен там в конфигурацию сессии, поэтому выбор Ф-1, Ф-2 или Ф-3 модель не переписывает.
