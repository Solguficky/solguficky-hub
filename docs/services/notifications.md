...
Напоминания участникам, подтвердившим RSVP, — первый непридуманный сценарий сервиса. Точные интервалы, opt-in, quiet hours, отмена и изменение времени сходки определяются требованиями. «24 часа» и «2 часа» — стартовая гипотеза, не архитектурный принцип.
