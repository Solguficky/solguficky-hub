...
Service brief описывает ответственность, жизненный слой, принятые границы и открытые вопросы. Сборка, запуск и структура исходников остаются в README конкретного сервиса.
...
| Mini App | MVP, scope Open | [mini-app.md](mini-app.md) |
