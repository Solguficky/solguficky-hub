...
Сейчас в репозитории есть силос Orleans со своей базой, миграции при старте, один грин-заглушка и command plane подписок и настроек категорий — шесть операций контракта из восьми. Обе ручные рассылки отвечают `Unimplemented` и принадлежат блоку обращения к подписчикам; реплика чужих фактов — PER-215, задание напоминания и sweeper — PER-222, потребление шины и доставка — PER-72.
