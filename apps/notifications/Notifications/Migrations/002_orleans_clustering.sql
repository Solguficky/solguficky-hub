...
-- коммит 137d9acc17830f15b13a4eb0058d6cee633cad5e, файл src/AdoNet/Orleans.Clustering.AdoNet/PostgreSQL-Clustering.sql.
--
...
--
-- Ловушка на апгрейд: CREATE OR REPLACE FUNCTION не умеет менять тип
-- возвращаемого значения и имена входных параметров — он падает с
-- «cannot change return type of existing function». Пока сигнатуры совпадают
-- с уже установленными, замена — no-op; если новая версия Orleans их изменит,
-- перевендоренный скрипт обязан начинаться с DROP FUNCTION IF EXISTS.
