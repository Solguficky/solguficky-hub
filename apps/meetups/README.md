...
Владелец данных и правил жизненного цикла сходки. Сейчас это доменное ядро среза и скелет вокруг него: команды и применение событий живут в `Domain/`, а gRPC-сервер по-прежнему отвечает на шесть операций контракта заглушкой — база и транспортные обработчики появятся следующими задачами.
