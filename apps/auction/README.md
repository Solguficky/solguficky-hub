...
Нужны JDK версии из `.java-version` и sbt. Ни то, ни другое репозиторий не ставит: `just auction-tools` только скачивает зависимости сборки.

## Команды

```bash
# Зависимости сборки, один раз после клонирования
just auction-tools
