...
```bash
# Локальная оркестрация — единая точка входа (infra/apphost/, ADR-020)
...
**Профили топологии** (`infra/apphost/`, детали — [ТЗ по Aspire](docs/06_TASKS/aspire-orchestration.md), [ADR-020](docs/04_DECISIONS/decisions.md)):
